#ifndef DEVICES_GPS_SRC_GPS_PORT_AUTODETECTOR_GPS_PORT_AUTODETECTOR_H_
#define DEVICES_GPS_SRC_GPS_PORT_AUTODETECTOR_GPS_PORT_AUTODETECTOR_H_
...
#endif  // DEVICES_GPS_SRC_GPS_PORT_AUTODETECTOR_GPS_PORT_AUTODETECTOR_H_
