#ifndef DEVICES_GPS_SRC_GPS_DEVICES_PORTS_EXPLORER_GPS_PORT_AUTODETECTOR_H_
#define DEVICES_GPS_SRC_GPS_DEVICES_PORTS_EXPLORER_GPS_PORT_AUTODETECTOR_H_
...
#endif  // DEVICES_GPS_SRC_GPS_DEVICES_PORTS_EXPLORER_GPS_PORT_AUTODETECTOR_H_
