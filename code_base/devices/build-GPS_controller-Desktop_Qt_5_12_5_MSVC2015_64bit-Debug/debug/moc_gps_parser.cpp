/****************************************************************************
** Meta object code from reading C++ file 'gps_parser.h'
**
...
#include "../../gps/controller/data_parser/gps_parser.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'gps_parser.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 10), // "gpsUpdated"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7), // "GpsData"
QT_MOC_LITERAL(4, 30, 4) // "data"

    },
    "GPSParser\0gpsUpdated\0\0GpsData\0data"
};
...
void GPSParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GPSParser::*)(const GpsData & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPSParser::gpsUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GPSParser::gpsUpdated(const GpsData & _t1)
{
